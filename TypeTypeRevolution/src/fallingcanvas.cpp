...
//        sf::RenderTarget::clear(sf::Color(0,0,100,0));
        // Load the image
//        crate=new Crate("Test");
//        crate->move(getView().getCenter().x ,0);
...
//                       Sprite.SetRotation(BodyIterator->GetAngle() * 180/b2_pi);
                       ...
                       sf::Text word;
                                              word.setFont(font);
                                              word.setString(crate->name);
                                              word.setCharacterSize(50);
                                              word.setStyle(sf::Text::Bold);
                                              word.sf::Text::setColor(sf::Color::Black);
                                              word.sf::Text::setPosition(body->GetPosition().x, -body->GetPosition().y);
